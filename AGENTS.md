...
This file is the quick-reference operating contract for pathdiff-kotlin. The longer
...
pathdiff-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`pathdiff`](https://crates.io/crates/pathdiff). Upstream Rust is the behavioral oracle while the
