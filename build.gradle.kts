...
kotlin {
    ...
    val xcf = XCFramework("Pathdiff")

    macosArm64 {
        binaries.framework { baseName = "Pathdiff"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Pathdiff"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Pathdiff"
        flattenPackage = "io.github.kotlinmania.pathdiff"
    }

    android {
        namespace = "io.github.kotlinmania.pathdiff"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "pathdiff-kotlin", version.toString())

    pom {
        name.set("pathdiff-kotlin")
        description.set("Kotlin Multiplatform port of Manishearth/pathdiff - Library for diffing paths to obtain relative paths")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/pathdiff-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/pathdiff-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/pathdiff-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/pathdiff-kotlin.git")
        }
    }
}
